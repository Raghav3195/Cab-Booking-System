...
class user:
    ...
    def new_user(self):
        ...
        #Find Existing usernsme if any take proper action
...
#Cab Select
        ...
        self.chkFordGalaxy=Radiobutton(Book_Frame,text="Ford Galaxy Cab",value=2,variable=carType,font=('arial',14,'bold'),command=selectCar).grid(row=1,column=0,sticky=W)
        ...
        self.chkSpecialNeeds=Radiobutton(Book_Frame,text="SpecialNeeds",value=3,variable=journeyType,font=('arial',14,'bold')).grid(row=2,column=2,sticky=W)
